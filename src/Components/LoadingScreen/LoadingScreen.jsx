...
const Loading = () => {
    return (
        <div className="flex items-center bg-[#19875487] justify-center h-screen w-full">
            <div className="text-center max-w-[20em] w-full">
                ...
                <div className="relative h-[1.5rem] text-[#198754] text-[1.5rem]">
                    <p className="absolute w-full">Bringing you the goods…</p>
                    <p className="absolute w-full preloader__msg--last">Loading...</p>
                </div>
            </div>
        </div>
    )
